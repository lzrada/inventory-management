...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        await axios.put("/api/lainnya/guru", payload);
        Swal.fire("Success", "Data berhasil diperbarui!", "success");
      } else {
        await axios.post("/api/lainnya/guru", payload);
  ...
  return (
    <div className="flex relative">
      ...
      <div className="flex flex-col p-4 flex-grow">
        ...
        {/* Tabel Ruangan */}
        <h2 className="flex justify-center text-3xl font-bold my-3">Data Master Ruang Guru</h2>
