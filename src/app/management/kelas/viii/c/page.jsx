...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put("/api/kelas/viii/c", form);
  ...
  return (
    <div className="flex relative">
      ...
      <div className="flex flex-col p-4 flex-grow">
          ...
          <div className="relative flex-col text-left mt-3">
            ...
            <div className="flex gap-3">
              <div className="w-11 h-11 border border-gray-400 rounded-xl mt-4">
                <Link href="/management/kelas/viii/a" className="w-full h-full flex object-fill items-center justify-center">
                  A
                </Link>
              </div>
              <div className="w-11 h-11 border border-gray-400 rounded-xl mt-4">
                <Link href="/management/kelas/viii/b" className="w-full h-full flex object-fill items-center justify-center">
                  B
                </Link>
              </div>
              <div className="w-11 h-11 border border-gray-400 rounded-xl mt-4">
                <Link href="/management/kelas/viii/c" className="w-full h-full flex object-fill items-center justify-center">
                  C
                </Link>
              </div>
            </div>
        ...
        {/* Tabel Ruangan */}
        <h2 className="flex justify-center text-3xl font-bold my-3">Management Data Kelas VIII C</h2>
